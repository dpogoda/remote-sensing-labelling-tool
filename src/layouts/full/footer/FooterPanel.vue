...
<template>
  <v-footer class="px-0 footer mt-2" style="position: fixed; bottom: 0; height: 50px; width: 100%; left: 0; z-index: 999999;">
    <v-row justify="center" align="center" no-gutters>
      <v-col cols="12" sm="6">
        <p class="text-body-1 mb-0 text-sm-left text-center pl-5 pr-5">
          <a  href="https://github.com/autocoast/home" target="_blank">
